...
public class ScaleGestureDetector {
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        @Override // com.js.styledtextview.textmodule.listener.ScaleGestureDetector.OnScaleGestureListener
                ...
                case 6:
                    ...
                    if (pointerCount > 2) {
                        if (actionId == this.mActiveId0) {
                            ...
                            int newIndex2 = findNewActiveIndex(event, this.mActiveId0, actionIndex);
                            if (newIndex2 >= 0) {
                                this.mListener.onScaleEnd(view, this);
