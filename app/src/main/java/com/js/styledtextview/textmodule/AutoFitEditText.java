...
public class AutoFitEditText extends EditText {
    ...
    public AutoFitEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            this._sizeTester = new SizeTester() {
                /* class com.js.styledtextview.textmodule.AutoFitEditText.AnonymousClass1 */
                final RectF textRect = new RectF();

                @Override // com.js.styledtextview.textmodule.AutoFitEditText.SizeTester
                @TargetApi(16)
                public int onTestSize(int suggestedSize, RectF availableSPace) {
                    ...
                    if (AutoFitEditText.this.getMaxLines() == 1) {
                        ...
                        StaticLayout layout = new StaticLayout(text, AutoFitEditText.this.paint, AutoFitEditText.this._widthLimit, Layout.Alignment.ALIGN_NORMAL, AutoFitEditText.this._spacingMult, AutoFitEditText.this._spacingAdd, true);
    ...
    private int efficientTextSizeSearch(int start, int end, SizeTester sizeTester, RectF availableSpace) {
        ...
        this._textCachedSizes.put(key, size2);
        return size2;
    }
